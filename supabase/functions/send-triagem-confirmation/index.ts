...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    if (tipo === "bpc_loas") {
      ...
      assunto = "Recebemos sua solicitação - Análise de Recurso INSS";
      conteudo = `
        <div style="font-family: 'Georgia', serif; max-width: 600px; margin: 0 auto; color: #333;">
          <div style="background-color: #5e6839; padding: 24px; text-align: center;">
            <h1 style="color: #fff; margin: 0; font-size: 24px;">Lilian Lima Advocacia</h1>
          ...
          <div style="padding: 32px 24px; background-color: #fafaf8;">
            ...
            <p style="line-height: 1.6;">
              Recebemos sua solicitação para <strong>análise de benefício indeferido pelo INSS</strong>.
            </p>
            
            <p style="line-height: 1.6;">
              Nossa equipe irá avaliar as informações fornecidas sobre o seu caso e entraremos em contato 
              em breve para orientar sobre os próximos passos.
            </p>

            <div style="background-color: #acba8f33; border-left: 4px solid #5e6839; padding: 16px; margin: 24px 0;">
              <p style="margin: 0; font-size: 14px;">
                <strong>Próximos passos:</strong><br>
                Aguarde nosso contato por e-mail ou WhatsApp. Se ainda não enviou, prepare os seguintes documentos:<br>
      ...
      throw new Error("Invalid triage type");
    }
